...
- Do not use `as unknown as SomeType` to force a type cast — prefer proper type guards, narrowing, or union discrimination instead. `as unknown as` bypasses the type system entirely and hides real type errors. Confidence: 0.70
