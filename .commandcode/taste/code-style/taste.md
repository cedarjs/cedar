...
- Use `spawnSync('git', [...args])` with argument arrays instead of `execSync('git ...')` with string commands for cross-platform safety — avoids shell involvement and quoting/escaping issues between Windows and Unix. Confidence: 0.80
