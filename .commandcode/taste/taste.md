...
# Code-Style
- Always document non-obvious code with comments — including why type casts are needed, and why certain workarounds exist. Confidence: 0.70
...
- Add blank lines after the closing curly brace of if statements, and generally prefer more vertical whitespace ("air") in code for readability. Confidence: 0.85
- Use `&apos;` HTML entities for apostrophes in JSX to avoid react/no-unescaped-entities lint errors. Confidence: 0.75
