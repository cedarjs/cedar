...
- Avoid `as` type casting in general. If a type cast is unavoidable, try a generic on `reduce`/similar first; if the cast must stay, add a short comment explaining why. Confidence: 0.85
