...
describe('cedar serve api --ud', () => {
  it('serves API functions, legacy handlers, and GraphQL', async () => {
    ...
    // 5. Native handleRequest function (direct API port)
    ...
    // 6. Legacy handler function (direct API port)
    ...
    // 7. GraphQL endpoint (direct API port)
    ...
    // 8. Web route should return the SPA shell
