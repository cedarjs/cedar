    ...
    [
      ...
      },
      {
        ...
        task: async (ctx) => {
          ...
          const source = fs.readFileSync(graphqlHandlerPath, 'utf-8')

          const { code, modified, skipped } =
            addRealtimeToGraphqlHandler(source)
          ...
          if (modified) {
            fs.writeFileSync(graphqlHandlerPath, code, 'utf-8')
          }
        },
      },
      {
