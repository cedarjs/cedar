...
`QUERY` and passes the matching slice of the query result down as a prop
named after the fragment, so nested Cells no longer create request waterfalls – one single
