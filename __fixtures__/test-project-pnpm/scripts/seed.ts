...
// Manually apply seeds via the `pnpm cedar prisma db seed` command.
//
// Seeds automatically run the first time you run the `pnpm cedar prisma migrate dev`
// command and every time you run the `pnpm cedar prisma migrate reset` command.
//
