...
│        realtime│jobs│mailer│uploads│record│codemods                  │
├──────────────────────────────────────────────────────────────────────┤
...
cedar dev:
  Default (no flags):
    concurrently ─┬─ api: cedar-api-server-watch (chokidar + esbuild, kept for
                  │      SSR/RSC)
...
| web                  | App shell. CedarProvider. createCell (GraphQL state→UI). Apollo (useQuery/useMutation). Head/MetaTags. FatalErrorBoundary. Toast. FetchConfig.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| api                  | Server runtime. Auth extraction. Validations (validate/validateWith). CORS. Logging (Pino). Cache (Redis/Memcached/InMemory). Webhooks. CedarError.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| storage              | Legacy file uploads, deprecated in favor of `uploads`. setupStorage→Prisma extension. FileSystem/Memory adapters. UrlSigner.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| uploads              | File uploads and storage. Named targets over a StorageProvider contract (fs/db/s3). Profiles signed into user-bound upload tokens. Fastify plugin (fs upload, signed serve, S3 webhook). @requireUploadToken/@withSignedUrl/@withDataUri directives. storeFile/deleteFile/cleanupStaleUploads. `./web` Uppy hooks and components.                                                                                                                                                                                                                               |
...
| testing              | Vitest config. MockProviders, MockRouter, mockGql, scenario helpers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| eslint-plugin        | Rules: process-env-computed, cell-type-annotations, service-type-annotations, unsupported-route-components.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| create-cedar-app     | Standalone scaffolding CLI. Interactive. TS/JS (always ESM). Copies templates.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
