...
Similarly to `cedar.toml`, `deploy.toml` supports interpolation of environment variables. For more details on how to use the environment variable interpolation see [Using Environment Variables in cedar.toml](/app-configuration-cedar-toml.md#using-environment-variables-in-cedartoml)
