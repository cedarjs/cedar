...
- `validation`, which accepts all of React Hook Form's [`register` options](https://react-hook-form.com/docs/useform/register), plus the Cedar-exclusive coercion helpers `valueAsBoolean`, `valueAsJSON`
